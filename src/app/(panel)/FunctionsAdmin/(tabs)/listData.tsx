...
export default function ListData() {
  ...
  const renderTransactionDetails = (transaction: Transaction) => {
    ...
    const getMainData = () => {
      switch (filter) {
        case "plate": return isVehicle ? transaction.plate : "Venda de Produtos";
        case "date": return formatDate(transaction.transaction_date);
        case "operator": return transaction.operator;
        case "type": return isVehicle ? "VEÍCULO" : "PRODUTO";
        default: return isVehicle ? transaction.plate : "Venda de Produtos";
      }
    };
      ...
      <View style={styles.transactionCard}>
        <View style={styles.cardHeader}>
          <View style={styles.mainDataContainer}>
            <Feather 
              name={iconMap[filter as keyof typeof iconMap] as keyof typeof Feather.glyphMap || undefined} 
              size={20} 
  ...
  return (
    <View style={styles.container}>
      ...
      <CashAlertModal
        ...
        type={cashStatus === "CLOSED" ? "block" : "info"}
        onClose={() => {
      ...
      {cashStatus === "OPEN" ? (
        ...
        <View style={styles.blockedContainer}>
          <Feather name="lock" size={48} color={Colors.orange[500]} />
          <Text style={styles.blockedText}>Caixa não está aberto</Text>
          <Text style={styles.blockedSubtext}>
            Você precisa abrir o caixa para acessar esta funcionalidade
          </Text>
        </View>
      )}
    </View>
