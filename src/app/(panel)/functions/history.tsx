...
import useHistory from "@/src/hooks/history/useHistory";
import { styles } from "@/src/styles/functions/historyStyles";
import { HistoryCashRegister, OutgoingExpense, ProductTransaction, VehicleTransaction } from "@/src/types/historyTypes/history";
